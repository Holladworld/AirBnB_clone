#!/usr/bin/python3
''' Seralizes instance to a JSON file and deserializes Json file to instances '''
...
class FileStorage:
    '''The file storage engine class; for serialization and deserialization to json format'''
